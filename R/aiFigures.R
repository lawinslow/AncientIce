Torn.1803 = read.table("/Users/Battrd/Documents/School&Work/WiscResearch/ancientIce/Sapna/Torn1803.txt", header=TRUE, sep="\t")

Suwa.Early = read.table("/Users/Battrd/Documents/School&Work/WiscResearch/ancientIce/Sapna/SuwaEarly101.txt", header=TRUE, sep="\t")
