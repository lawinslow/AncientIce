...
# =========================================
bp.opts <- 10:(nrow(suwa)-10) #seq(50, 500, by=25) #101:500
...
# ====================================================
# = Suwa: plot time series and breakpoint likelihood =
# ====================================================
...
# plot(tornio[,"year"], tornio[,"doy"], type="l")
...
# plot(tornio[,"year"], tornio[,"doy"], type="l", xlim=range(suwa[,"year"]))
lines(tornio[tornio.bp.i,"year"], tornio[tornio.bp.i,"bp.pred"], col="yellow", lwd=3)
lines(tornio[!tornio.bp.i,"year"], tornio[!tornio.bp.i,"bp.pred"], col="red", lwd=3)
