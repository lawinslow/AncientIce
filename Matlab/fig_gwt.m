...
d = importdata('../Data/Torn/torn.allyears.tsv');
...
n = length(data);
dt = 1;
time = d.data(:,1);  % construct time array
xlim = [1700,2010];  % plotting range
...
%% export
export_fig('../Figures/TornOverallWavelet.tiff','-r300');
